...
2. Data are analysed and manipulate using _**functions**_. Functions have a name that is followed by brackets. Pieces of information required by a function (data, parameters) are typed between the brackets and are called a function's _**arguments**_.  
